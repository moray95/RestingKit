...
//  String.swift
//  RestingKit
//  Taken from Swift's JSONEncoder
//
...
extension String {
 func convertToSnakeCase() -> String {
    ...
    while let upperCaseRange = self.rangeOfCharacter(from: CharacterSet.uppercaseLetters,
        ...
        guard let lowerCaseRange = self.rangeOfCharacter(from: CharacterSet.lowercaseLetters,
